...
import { Gift, Sparkles, Crown, Zap, X, Check, Star, ArrowLeft, Server, Clock, HardDrive } from 'lucide-react';
...
export default function GiftPopup() {
  ...
  const handleClaim = async () => {
    ...
    const { data: planData } = await supabase.from('plans').select('id').eq('name', gift.plan_name).maybeSingle();
    ...
    // Mark as claimed
    await supabase.from('gifts').update({ claimed: true }).eq('id', gift.id);
          ...
          {!claimed ? (
              ...
              <div className="glass rounded-2xl p-8 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  >
                    ...
                    {gift.message && (
                      <p className="text-sm text-muted-foreground mt-2 italic">"{gift.message}"</p>
                    )}
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center gap-4 text-xs text-muted-foreground">
                      <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> 30 يوم</span>
                      <span className="flex items-center gap-1"><Zap className="w-3 h-3" /> فورية</span>
                    </div>
                  </motion.div>
            ...
            >
              ...
              <motion.h2 initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }}
                ...
                <span className="text-green-400">تم استلام الهدية!</span>
              </motion.h2>
